...
export class GooglemapComponent {
    ...
    showconfirmdialoge1(lang,area){ {
        ...
        let alert = this._AlertController.create({
          //title: 'Please Check !',
          message: 'कृपया सुनिश्चित करें कि क्षेत्र हेक्टेयर में है!',
          buttons: [
            {
              text: 'रद्द करे  ',
              role: 'cancel',
